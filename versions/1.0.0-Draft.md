...
Based on the standards proposed by the [OpenAPI Initiative](https://openapis.org), SLA4OAI builds on top of the [OpenAPI Specification](https://openapis.org/specification) to add an optional profile for defining SLA (Service Level Agreements) over the APIs.
