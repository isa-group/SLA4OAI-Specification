...
The goal of the [SLA4OAI Specification](./Specification-1.0.0-Draft.md) is to promote an open specification for
...
The current version of the SLA4OAI Specification **Draft** is 1.0.0 and you can find it [here](./Specification-1.0.0-Draft.md)
